...
tern_plot <-
  ...
  labs(title = "A transition to cleaner energy",
       subtitle = "The direction of Europe's largest energy producers",
       x = "Conventional\nthermal", xarrow = "", 
       y = "Renewable", yarrow = "",
  ...
  theme_nolabels() +
  theme_arrowlarge() +
  theme(tern.axis.arrow = element_line(color = "grey10", size = 2),
        tern.axis.title = element_text(colour = "grey55",
                                       family = "Avenir Next Condensed",
                                       face = "bold",
                                       size = 13),
        tern.axis.title.L = element_text(hjust = 0, vjust = -0.5),
        tern.axis.title.R = element_text(hjust = 1, vjust = -1.5),
        tern.axis.title.T = element_text(hjust = 0.5, vjust = 1.5),
        tern.axis.arrow.sep = .05, 
        tern.axis.arrow.text.R = element_text(colour = "grey55",
                                       family = "Avenir Next",
                                       face = "italic",
                                       size = 5),
        plot.margin = margin(50,30,10,30), #t, r, b, l
...
ggsave("tern_plot.png", width = 10, height = 10)
